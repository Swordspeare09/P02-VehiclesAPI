...
- Implement the `TODOs` within the `CarService.java` and `CarController.java`  files. All Completed!
- Add additional tests to the `CarControllerTest.java` file based on the `TODOs`. Completed!
- Implement API documentation using Swagger. Completed!
